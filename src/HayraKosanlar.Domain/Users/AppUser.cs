...
namespace HayraKosanlar.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update HayraKosanlarDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update HayraKosanlarEfCoreEntityExtensionMappings to extend the IdentityUser entity
