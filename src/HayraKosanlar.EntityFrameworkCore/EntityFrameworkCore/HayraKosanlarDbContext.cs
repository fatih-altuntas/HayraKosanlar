...
namespace HayraKosanlar.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See HayraKosanlarMigrationsDbContext for migrations.
     */
    [ConnectionStringName("Default")]
    public class HayraKosanlarDbContext : AbpDbContext<HayraKosanlarDbContext>
    {
        ...
        public HayraKosanlarDbContext(DbContextOptions<HayraKosanlarDbContext> options)
            : base(options)
        {
